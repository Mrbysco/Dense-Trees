...
public class DenseTreePlacements {
	...
	public static final ResourceKey<PlacedFeature> DENSE_JUNGLE_TREE_CHECKED = createPlacementKey("dense_jungle_tree");
	public static final ResourceKey<PlacedFeature> DENSE_FANCY_OAK_CHECKED = createPlacementKey("dense_fancy_oak_checked");
	public static final ResourceKey<PlacedFeature> DENSE_MEGA_JUNGLE_TREE_CHECKED = createPlacementKey("dense_mega_jungle_tree_checked");
	public static final ResourceKey<PlacedFeature> DENSE_MEGA_SPRUCE_CHECKED = createPlacementKey("dense_mega_spruce_checked");
	public static final ResourceKey<PlacedFeature> DENSE_MEGA_PINE_CHECKED = createPlacementKey("dense_mega_pine_checked");
	public static final ResourceKey<PlacedFeature> DENSE_TALL_MANGROVE_CHECKED = createPlacementKey("dense_tall_mangrove_checked");
