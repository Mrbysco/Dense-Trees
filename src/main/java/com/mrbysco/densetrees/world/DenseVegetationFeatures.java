...
public class DenseVegetationFeatures {
	...
	public static final ResourceKey<ConfiguredFeature<?, ?>> DENSE_TREES_BIRCH_AND_OAK_LEAF_LITTER = createConfiguredKey("dense_trees_birch_and_oak_leaf_litter");
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
		...
		FeatureUtils.register(context, DENSE_TREES_BIRCH_AND_OAK_LEAF_LITTER, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedGetter.getOrThrow(DenseTreePlacements.DENSE_FALLEN_BIRCH_TREE), 0.0025F), new WeightedPlacedFeature(placedGetter.getOrThrow(DenseTreePlacements.DENSE_BIRCH_BEES_0002_LEAF_LITTER), 0.2F), new WeightedPlacedFeature(placedGetter.getOrThrow(DenseTreePlacements.DENSE_FANCY_OAK_BEES_0002_LEAF_LITTER), 0.1F), new WeightedPlacedFeature(placedGetter.getOrThrow(DenseTreePlacements.DENSE_FALLEN_OAK_TREE), 0.0125F)), placedGetter.getOrThrow(DenseTreePlacements.DENSE_OAK_BEES_0002_LEAF_LITTER)));
